...
// STUDENT TOTAL CAO
    public static int getStudentTotal_CAO(int studentTotal_CAO) {
        return studentTotal_CAO = getMaths(maths) +
                getCommunications(communications) +
                getWorkEx(workEx) + getPhysics(physics) +
                getEnglish(english) + getCoding(coding);
    }
...
// PRINT INFO
    public static void printInfo() {
        ...
        boolean goCollege = printInfo_getStudentTotal_CAO >= maxCAO;
        if (goCollege) {
